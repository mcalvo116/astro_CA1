...
#define taua _ml->template fpfield<5>(_iml)
#define taua_columnindex 5
#define taub _ml->template fpfield<6>(_iml)
#define taub_columnindex 6
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"taua"} /* 5 */,
                                       _nrn_mechanism_field<double>{"taub"} /* 6 */,
 ...
 v=_v;
{
 ...
 { error =  state();
 if(error){
  std_cerr_stream << "at line 52 in file km.mod:\nBREAKPOINT {\n";

...
#define nrn_init _nrn_init__kadmio
#define _nrn_initial _nrn_initial__kadmio
#define nrn_cur _nrn_cur__kadmio
#define _nrn_current _nrn_current__kadmio
#define nrn_jacob _nrn_jacob__kadmio
#define nrn_state _nrn_state__kadmio
#define _net_receive _net_receive__kadmio 
#define rates rates__kadmio 
#define states states__kadmio 
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_kadmio", _hoc_setdata},
 {"alpl_kadmio", _hoc_alpl},
 {"alpn_kadmio", _hoc_alpn},
 {"betl_kadmio", _hoc_betl},
 {"betn_kadmio", _hoc_betn},
 {"rates_kadmio", _hoc_rates},
 {0, 0}
};
...
#define alpl alpl_kadmio
#define alpn alpn_kadmio
#define betl betl_kadmio
#define betn betn_kadmio
 ...
 #define gind 0
 #define _gth 0
#define a0n a0n_kadmio
 double a0n = 0.1;
#define a0l a0l_kadmio
 double a0l = 0.05;
#define gml gml_kadmio
 double gml = 1;
#define gmn gmn_kadmio
 double gmn = 0.39;
#define linf linf_kadmio
 double linf = 0;
#define lmin lmin_kadmio
 double lmin = 2;
#define ninf ninf_kadmio
 double ninf = 0;
#define nmin nmin_kadmio
 double nmin = 0.2;
#define pw pw_kadmio
 double pw = -1;
#define qtl qtl_kadmio
 double qtl = 1;
#define q10 q10_kadmio
 double q10 = 5;
#define qq qq_kadmio
 double qq = 5;
#define taun taun_kadmio
 double taun = 0;
#define taul taul_kadmio
 double taul = 0;
#define tq tq_kadmio
 double tq = -40;
#define vhalfl vhalfl_kadmio
 double vhalfl = -50;
#define vhalfn vhalfn_kadmio
 double vhalfn = 4.5;
#define zetal zetal_kadmio
 double zetal = 3;
#define zetan zetan_kadmio
 double zetan = -1.8;
 ...
 {"vhalfn_kadmio", &vhalfn_kadmio},
 {"vhalfl_kadmio", &vhalfl_kadmio},
 {"a0l_kadmio", &a0l_kadmio},
 {"a0n_kadmio", &a0n_kadmio},
 {"zetan_kadmio", &zetan_kadmio},
 {"zetal_kadmio", &zetal_kadmio},
 {"gmn_kadmio", &gmn_kadmio},
 {"gml_kadmio", &gml_kadmio},
 {"lmin_kadmio", &lmin_kadmio},
 {"nmin_kadmio", &nmin_kadmio},
 {"pw_kadmio", &pw_kadmio},
 {"tq_kadmio", &tq_kadmio},
 {"qq_kadmio", &qq_kadmio},
 {"q10_kadmio", &q10_kadmio},
 {"qtl_kadmio", &qtl_kadmio},
 {"ninf_kadmio", &ninf_kadmio},
 {"linf_kadmio", &linf_kadmio},
 {"taul_kadmio", &taul_kadmio},
 {"taun_kadmio", &taun_kadmio},
 {0, 0}
};
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 54 in file kadist_dopa.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
  ...
  "        v (mV)\n"
  "        gkabar=.008 (mho/cm2)\n"
  "        vhalfn=4.5   (mV) :johnston et al 1999 pka ca1 +12.5mV, aragosta -8, ex 11.5\n"
  "        vhalfl=-50  (mV) :johnston et al 1999 pka ca1 +5mV, aragosta uguale a originale, ex -51\n"
  "        a0l=0.05      (/ms)\n"
  "        a0n=.1    (/ms)\n"
  "        zetan=-1.8    (1)\n"
  "        zetal=3    (1)\n"

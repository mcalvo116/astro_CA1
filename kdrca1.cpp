...
#define gkdrbar _ml->template fpfield<0>(_iml)
#define gkdrbar_columnindex 0
#define gkdr _ml->template fpfield<1>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"gkdrbar"} /* 0 */,
                                       _nrn_mechanism_field<double>{"gkdr"} /* 1 */,
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 44 in file kdrca1.mod:\nBREAKPOINT {\n";

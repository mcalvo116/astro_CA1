...
#define irest _ml->template fpfield<1>(_iml)
#define irest_columnindex 1
#define tau _ml->template fpfield<2>(_iml)
#define tau_columnindex 2
#define cai0 _ml->template fpfield<3>(_iml)
#define cai0_columnindex 3
#define cmax _ml->template fpfield<4>(_iml)
#define cmax_columnindex 4
#define ca_tmax _ml->template fpfield<5>(_iml)
#define ca_tmax_columnindex 5
...
#define Dcai _ml->template fpfield<9>(_iml)
#define Dcai_columnindex 9
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 6, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 12);
 	...
 	irest = _parm_default[1]; /* 0 */
 	tau = _parm_default[2]; /* 100 */
 	cai0 = _parm_default[3]; /* 5e-05 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 12);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"irest"} /* 1 */,
                                       _nrn_mechanism_field<double>{"tau"} /* 2 */,
                                       _nrn_mechanism_field<double>{"cai0"} /* 3 */,
                                       _nrn_mechanism_field<double>{"cmax"} /* 4 */,
                                       _nrn_mechanism_field<double>{"ca_tmax"} /* 5 */,
                                       _nrn_mechanism_field<double>{"i"} /* 6 */,
                                       _nrn_mechanism_field<double>{"ica"} /* 7 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 8 */,
                                       _nrn_mechanism_field<double>{"Dcai"} /* 9 */,
...
/*static int _ode_matsol1(_internalthreadargsproto_);*/
 ...
 static int integrate(_internalthreadargsproto_);
 
/*CVODE*/
 static int _ode_spec1 (_internalthreadargsproto_) {int _reset = 0; {
   Dcai = - ( ica + irest ) / depth / F / 2.0 * ( 1e4 ) + ( cai0 - cai ) / tau ;
   }
 return _reset;
}
 static int _ode_matsol1 (_internalthreadargsproto_) {
...
static int integrate (_internalthreadargsproto_) {
 ...
 error = nrn_newton_thread(_newtonspace1, 1, _slist2, neuron::scopmath::row_view{_ml, _iml}, integrate, _dlist2, _ml, _iml, _ppvar, _thread, _globals, _nt);
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 {  _deriv1_advance = 1;
 derivimplicit_thread(1, _slist1, _dlist1, neuron::scopmath::row_view{_ml, _iml}, integrate, _ml, _iml, _ppvar, _thread, _globals, _nt);
_deriv1_advance = 0;
     if (secondorder) {
    int _i;
    for (_i = 0; _i < 1; ++_i) {
